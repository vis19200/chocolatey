...
[I$tempDir = Join-Path $chocoTempDir -ChildPath "chocoInstall"
[O
...
[I            throw ($errorMessage, $errorDetails -join [Environment]::NewLine)
        }
    }
} else {
...
if (-not $chocoPath) {
[O    $chocoPath = "$env:ALLUSERSPROFILE\Chocolatey"
}
...
[I[O# dzAkBggrBgEFBQcwAYYYaHR0cDovL29jc3AuZGlnaWNlcnQuY29tME8GCCsGAQUF
...
[I# LmNvbTExMC8GA1UEAxMoRGlnaUNlcnQgU0hBMiBBc3N1cmVkIElEIENvZGUgU2ln
